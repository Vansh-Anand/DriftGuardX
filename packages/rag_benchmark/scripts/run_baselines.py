...
def main():
    parser = argparse.ArgumentParser(description="Run classical ML baselines for Trace Anomaly Detection")
    parser.add_argument("--dataset", type=str, default="data/trace_dataset.json", help="Path to flattened trace dataset")
    parser.add_argument("--output", type=str, default="data/baseline_results.json", help="Output path for results")
