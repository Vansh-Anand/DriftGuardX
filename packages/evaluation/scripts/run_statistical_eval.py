...
def main() -> None:
    ...
    configs_to_compare = [c for c in config_metrics if c != baseline_config]
    ...
    for metric in metrics_list:
        ...
        for config in configs_to_compare:
            ...
            print(
                f"| {metric} | {config} | {stats['proposed_mean']:.3f} | {stats['baseline_mean']:.3f} | {diff_str} | {ci_str} | {p_val_str} | {stats['effect_size_cohens_d']:.3f} |"
            )
