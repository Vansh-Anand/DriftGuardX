...
class LearnedGATDiffusion(nn.Module):
    ...
    def __init__(self, in_channels=2, hidden_channels=16, out_channels=1, heads=2, num_layers=2):
        ...
        self.convs.append(GATv2Conv(in_channels, hidden_channels, heads=heads, edge_dim=2, concat=False))
        
        for _ in range(num_layers - 1):
            self.convs.append(GATv2Conv(hidden_channels, hidden_channels, heads=heads, edge_dim=2, concat=False))
