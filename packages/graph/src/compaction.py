...
class CompactionGuard:
    ...
    """
    def __init__(self, entailment_provider: EntailmentProvider | None = None, fail_behavior: str = "fail_closed"):
        ...
        for claim in claims:
            ...
            if decision.classification == "UNKNOWN":
                if self.fail_behavior == "fail_closed":
                    ...
                    return CompactionResult(is_valid=False, claims=recorded_claims) # For automation, require_human_review fails open loop
