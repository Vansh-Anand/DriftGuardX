...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_ledger_entries_commit_hash", "ledger_entries", ["commit_hash"], unique=False
    )
    ...
    op.create_index(
        "ix_recovery_states_status", "recovery_states", ["current_status"], unique=False
    )
    ...
    if bind.dialect.name == "postgresql":
        ...
        tables = ["jobs", "approval_requests", "recovery_states", "ledger_entries"]
