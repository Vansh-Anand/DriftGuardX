...
def main():
    ...
    run_parser.add_argument("--regime", type=str, default="retrieval-only", help="Evaluation regime")
    run_parser.add_argument("--seed", type=int, default=42, help="Random seed for fault overlays")

    # Plot command
    plot_parser = subparsers.add_parser("plot", help="Generate publication-grade plots from reports")
