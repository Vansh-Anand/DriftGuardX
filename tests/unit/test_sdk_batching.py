...
def test_batch_spans_success(sync_client):
    spans = [SpanIngestItem(trace_id="a", span_id=f"span-{i}", parent_span_id=None, run_id="r1", tenant_id="t1", pipeline_id="p1", name="test", kind="INTERNAL", start_time="2021-01-01T00:00:00Z", attributes={}) for i in range(3)]
...
def test_batch_spans_retryable_5xx(sync_client):
    spans = [SpanIngestItem(trace_id="a", span_id="span-1", parent_span_id=None, run_id="r1", tenant_id="t1", pipeline_id="p1", name="test", kind="INTERNAL", start_time="2021-01-01T00:00:00Z", attributes={})]
...
def test_batch_spans_multiple_chunks(sync_client):
    ...
    spans = [SpanIngestItem(trace_id="a", span_id=f"span-{i}", parent_span_id=None, run_id="r1", tenant_id="t1", pipeline_id="p1", name="test", kind="INTERNAL", start_time="2021-01-01T00:00:00Z", attributes={}) for i in range(5)]
...
def test_batch_spans_partial_failure(sync_client):
    sync_client._max_batch_size = 2
    spans = [SpanIngestItem(trace_id="a", span_id=f"span-{i}", parent_span_id=None, run_id="r1", tenant_id="t1", pipeline_id="p1", name="test", kind="INTERNAL", start_time="2021-01-01T00:00:00Z", attributes={}) for i in range(4)]
