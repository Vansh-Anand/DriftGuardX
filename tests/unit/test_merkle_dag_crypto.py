import pytest
from packages.replay.src.merkle_dag import MerkleNode, MerkleDAGStore
...
def test_leaf_and_internal_domain_separation():
    ...
    internal = MerkleNode(node_id="internal", payload="", parent_hashes=["dummy_parent_hash"], version="v1")
...
def test_child_ordering():
    ...
    node1 = MerkleNode(node_id="n1", payload="payload", parent_hashes=["hashB", "hashA"], version="v1")
    node2 = MerkleNode(node_id="n2", payload="payload", parent_hashes=["hashA", "hashB"], version="v1")
